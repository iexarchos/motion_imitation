...
from motion_imitation.envs import locomotion_gym_env, locomotion_gym_env_scaled
...
def build_scaled_env(robot_class,
                      motor_control_mode,
                      enable_rendering=False,
                      on_rack=False,
                      action_limit=(0.75, 0.75, 0.75),
  ...
  sensors = [
      ...
      robot_sensors.IMUSensor(),
      robot_sensors.MotorAngleSensor(num_motors=a1.NUM_MOTORS),
      robot_sensors.ScaleSensor(),
  ]

  task = simple_forward_task.SimpleForwardTask()

  env = locomotion_gym_env_scaled.LocomotionGymEnvScaled(gym_config=gym_config,
                                            robot_class=robot_class,
                                            robot_sensors=sensors,
                                            task=task)
