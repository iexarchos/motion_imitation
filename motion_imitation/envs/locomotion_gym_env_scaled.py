...
class LocomotionGymEnvScaled(gym.Env):
  ...
  def reset(self,
    ...
    self._hard_reset = True #make sure hard reset always remains True! 
    #print('hard reset: ', self._hard_reset)
    if self._hard_reset:
    ...
    self._robot.Reset(reload_urdf=False, #needs to be False!
