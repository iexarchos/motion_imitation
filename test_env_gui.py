...
FLAGS = flags.FLAGS
flags.DEFINE_enum('robot_type', 'A1Scaled', ['A1', 'Laikago', 'A1Scaled'], 'Robot Type.')
...
ROBOT_CLASS_MAP = {'A1': a1.A1, 'Laikago': laikago.Laikago, 'A1Scaled': a1_scaled.A1}
...
def main(_):
  ...
  env = env_builder.build_scaled_env(robot,
